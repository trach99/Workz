...
def xtractTLV(foo):
    ...
    if tag | 0x80 == 0x81:
        ...
        result.append("    General result = \"" + Results.generalResult[foo[0]] + "\"")
        for n in range(length): 
            foo.pop(0)
        ...
        result.append("    Length = " + str(length) + " bytes")
        result.append("    Data coding scheme = " + hex(foo.pop(0)))
        text = '    "'
        ...
        result.append("    Length = " + str(length) + " bytes")
        result.append("    Identifier of item = " + hex(foo.pop(0)))
        itemText = '    "'
        for n in range(length - 1): 
...
def decomposeProactiveCommand(data):
    ...
    result.append("Type of command = " + typeOfCommand[data[3]])
...
def onCommand(s):
    ...
    if ins == 0x12:
        ...
        result = "Instruction = Terminal Response\n"
